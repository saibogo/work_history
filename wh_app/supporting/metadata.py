...
CHANGELOG = [
    ...
    ('0.44.2', 'Реализован просмотр текущих заявок при выборе предприятия в телеграмм-версии'),
    ('0.45.0', 'начата реализация иснтрукции по использованияю системы'),
    ('0.45.2', 'Начата реализация роли Инженера службы эксплуатации')
]
