...
NO_ROLE = 'no_role'
ROLES_IERARH = [ROLE_SUPERUSER, ROLE_ENGINEER, ROLE_WORKER, ROLE_CUSTOMER, NO_ROLE]
...
def get_role_description(role: str) -> str:
    ...
    if role == NO_ROLE:
        ...
        result = "Инженер службы эксплуатации(Доступны все функции, кроме просмотра схем калькуляции и систем администрирования)"
...
def is_valid_password(password: str) -> bool:
    ...
    if user_role in [ROLE_SUPERUSER, ROLE_ENGINEER, ROLE_WORKER, NO_ROLE]:
